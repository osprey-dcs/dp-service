...
public class QueryConfigurationManagerTest {
    ...
    public void testBenchmark() {
        assertTrue("unexpected value for resource: " + BenchmarkQueryResponseStream.CFG_KEY_GRPC_CONNECT_STRING,
                configMgr.getConfigString(BenchmarkQueryResponseStream.CFG_KEY_GRPC_CONNECT_STRING)
                        .equals(BenchmarkQueryResponseStream.DEFAULT_GRPC_CONNECT_STRING));
    }
