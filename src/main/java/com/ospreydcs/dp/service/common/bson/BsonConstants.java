...
public class BsonConstants {
    ...
    public static final String BSON_KEY_BUCKET_NAME = "columnName";
    ...
    public static final String BSON_KEY_BUCKET_EVENT_NANOS = "eventNanos";
    public static final String BSON_KEY_BUCKET_NUM_SAMPLES = "numSamples";
    public static final String BSON_KEY_BUCKET_SAMPLE_FREQUENCY = "sampleFrequency";
    public static final String BSON_KEY_BUCKET_ATTRIBUTE_MAP = "attributeMap";
    public static final String BSON_KEY_BUCKET_COLUMN_DATA_LIST = "columnDataList";
