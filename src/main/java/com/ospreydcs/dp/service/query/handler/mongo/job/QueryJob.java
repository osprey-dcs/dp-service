...
import com.ospreydcs.dp.service.query.handler.mongo.dispatch.QueryResponseDispatcher;
...
public class QueryJob extends HandlerJob {
    ...
    private final QueryResponseDispatcher dispatcher;
    ...
    public QueryJob(QueryRequest.QuerySpec spec,
                    QueryResponseDispatcher dispatcher,
    ...
    public void execute() {
        ...
        logger.debug("dispatching query result job id: {}", this.responseObserver.hashCode());
