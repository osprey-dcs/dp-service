...
(`ghcr.io/osprey-dcs/dp-service`) declares all eight ports. Released images are signed; the
"Container Image" section of [`README.env`](../README.env) has the `cosign verify` command.
